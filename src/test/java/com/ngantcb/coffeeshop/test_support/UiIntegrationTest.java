package com.ngantcb.coffeeshop.test_support;

import com.ngantcb.coffeeshop.CoffeeShopApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "coffee_MainScreen", screenBasePackages = "com.ngantcb.coffeeshop.screen")
@ContextConfiguration(classes = {CoffeeShopApplication.class, UiTestAssistConfiguration.class})
